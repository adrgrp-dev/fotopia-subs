		...
		<div class="coverflow-slider">
             ...
             <br>
                        ...
                        <div class="error-box"  style="display:block;">
                            ...
                            adr_trans=""><i style="color: #ff3300;">Your Email is not verified.</i></div>
                            <div class="text-danger" id="label_notified_approved" adr_trans=""><i style="color: #ff3300;">Please check your email and verify your account.</i></div>
                        </div>
						<?php } ?>
