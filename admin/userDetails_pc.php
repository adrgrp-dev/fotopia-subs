...
else
{
	...
	if(@$get_user['type_of_user']!='PCAdmin')
	{
		...
		header("location:userDetails_pc.php?val=2&success=1&id=$id");
	}
	else{
	mysqli_query($con,"update admin_users set is_approved=1 where id='$id1'");
	header("location:userDetails_pc.php?val=2&success=1&id1=$id1");
}
}
elseif(isset($_REQUEST['block']))
{
	...
	mysqli_query($con,"update user_login set email_verified=2 where id='$id'");
		header("location:userDetails_pc.php?val=2&declined=1&id=$id");
  }
	else{
		$id1=$_REQUEST['id1'];
		mysqli_query($con,"update admin_users set is_approved=2 where id='$id1'");
			header("location:userDetails_pc.php?val=2&declined=1&id1=$id1");
	}
	   ...
	   <tr><td  style="float:right;"><img src="data:<?php echo $res1['profile_pic_image_type']; ?>;base64,<?php echo base64_encode($res1['profile_pic']); ?>" width="50" height="50" style="border-radius: 35px;" /></td><td style="padding:0px 0px;vertical-align:top;"> </td><td><?php echo $res1['first_name']. $res1['last_name']; ?><hr class="space xs"></td></tr>
	    <tr><td colspan="3"><hr class="space xs" /></td></tr>
         ...
         <p align="right" style="margin-top:10px;margin-right: 82px;">
				...
				<a class="anima-button circle-button btn-sm btn adr-save" href="userDetails_pc.php?val=2&approve=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i><span adr_trans="label_approve">Approve</span></a> <?php }


				elseif($res1['email_verified']==1) { ?>

								<a class="anima-button circle-button adr-cancel btn-sm btn" href="userDetails_pc.php?val=2&block=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-ban"></i><span adr_trans="label_block">Block</span></a><?php }

								else{ ?>
<a class="anima-button circle-button adr-save btn-sm btn" href="userDetails_pc.php?val=2&approve=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i><span adr_trans="label_approve">Approve</span></a>

<a class="anima-button circle-button adr-cancel btn-sm btn" href="userDetails_pc.php?val=2&block=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-ban"></i><span adr_trans="label_block">Block</span></a>
<?php } }
else{
?>
<?php
if($res1['is_approved']==2) { ?>
<a class="anima-button circle-button adr-save btn-sm btn" href="userDetails_pc.php?val=2&approve=1&id1=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i><span adr_trans="label_approve">Approve</span></a> <?php }


elseif($res1['is_approved']==1) { ?>

				<a class="anima-button circle-button adr-cancel btn-sm btn" href="userDetails_pc.php?val=2&block=1&id1=<?php echo $res1['id']; ?>"><i class="fa fa-ban"></i><span adr_trans="label_block">Block</span></a><?php }

				else{ ?>
<a class="anima-button circle-button adr-save btn-sm btn" href="userDetails_pc.php?val=2&approve=1&id1=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i><span adr_trans="label_approve">Approve</span></a>

<a class="anima-button circle-button adr-cancel btn-sm btn" href="userDetails_pc.php?val=2&block=1&id1=<?php echo $res1['id']; ?>"><i class="fa fa-ban"></i><span adr_trans="label_block">Block</span></a>
<?php
}
}?>
								<?php
