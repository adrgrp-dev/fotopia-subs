...
<div id="step2" name="step2" style="display:none" >
    ...
    <div class="col-md-6">
                                ...
                                <input id="org_name" name="org_name" placeholder="Company name" type="text" autocomplete="off" class="form-control form-value" list="companies1" onkeyup="get_companies(this.value,event)" onchange="companies(this.value)" required="" >
